...
let seiza tsuki hi = 
    if tsuki = 1 then if 1 <= hi && hi <= 19 then "山羊座"
                    ...
                    else if 24 <= hi && hi <= 31 then "蟹座" 
                    else "無し"
    else if tsuki = 11 then if 1 <= hi && hi <= 22 then "蟹座"
...
(*test*)
let test1 = seiza 1 10 = "山羊座"
let test2 = seiza 1 31 = "水瓶座"
let test3 = seiza 12 16 = "射手座"
let test4 = seiza 12 31 = "山羊座"
